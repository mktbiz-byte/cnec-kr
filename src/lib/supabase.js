...
// Supabase 설정 - CNEC Korea 프로젝트
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://vluqhvuhykncicgvkosd.supabase.co'
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZsdXFodnVoeWtuY2ljZ3Zrb3NkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjEyNjg2MzAsImV4cCI6MjA3Njg0NDYzMH0.ikEqdx6Le54YJUP-NROKg6EmeHJ4TbKkQ76pw29OQG8'
    ...
    async upsert(profileData) {
      return safeQuery(async () => {
        ...
        const cleanData = {
          ...
          no_instagram: profileData.no_instagram || false,
          no_youtube: profileData.no_youtube || false,
          no_tiktok: profileData.no_tiktok || false,
          // SNS 개별 팔로워/구독자
