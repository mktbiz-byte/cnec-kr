...
CNEC Korea 팀`,
    ...
    {
      id: 'campaign_deadline_3days',
      name: language === 'ja' ? 'キャンペーン締切3日前リマインダー' : '캠페인 마감 3일전 알림',
      subject: language === 'ja' ? '📅 キャンペーン締切まで3日です' : '📅 캠페인 마감까지 3일 남았습니다',
      content: language === 'ja' ? 
        `{{name}} さん、

「{{campaign_title}}」キャンペーンの締切まで3日となりました。

締切: {{deadline}}
ブランド: {{brand_name}}
보상: ₩{{reward_amount}}

まだ動画を投稿していない場合は、お早めに制作・投稿をお願いいたします。
...
「{{campaign_title}}」 캠페인 마감까지 3일 남았습니다.

마감일: {{deadline}}
브랜드: {{brand_name}}
보상금: ₩{{reward_amount}}

아직 영상을 게시하지 않으셨다면, 서둘러 제작·게시해주시기 바랍니다.
...
CNEC Korea 팀`,
      variables: ['name', 'campaign_title', 'deadline', 'brand_name', 'reward_amount', 'requirements', 'upload_folder', 'guidelines_url'],
      category: 'reminder'
    },
    {
      id: 'campaign_deadline_2days',
      name: language === 'ja' ? 'キャンペーン締切2日前リマインダー' : '캠페인 마감 2일전 알림',
      subject: language === 'ja' ? '⚠️ キャンペーン締切まで2日です' : '⚠️ 캠페인 마감까지 2일 남았습니다',
      content: language === 'ja' ? 
        `{{name}} さん、

「{{campaign_title}}」キャンペーンの締切まで2日となりました。

締切: {{deadline}}
ブランド: {{brand_name}}
보상: ₩{{reward_amount}}

⚠️ 重要: まだ動画を投稿していない場合は、今すぐ制作・投稿をお願いいたします。
...
「{{campaign_title}}」 캠페인 마감까지 2일 남았습니다.

마감일: {{deadline}}
브랜드: {{brand_name}}
보상금: ₩{{reward_amount}}

⚠️ 중요: 아직 영상을 게시하지 않으셨다면, 지금 즉시 제작·게시해주시기 바랍니다.
...
마감일을 넘기면 보상금을 지급할 수 없으니 주의해주세요.
...
CNEC Korea 팀`,
    ...
    {
      id: 'campaign_deadline_1day',
      name: language === 'ja' ? 'キャンペーン締切1日前リマインダー' : '캠페인 마감 1일전 알림',
      subject: language === 'ja' ? '🚨 キャンペーン締切まで1日です！' : '🚨 캠페인 마감까지 1일 남았습니다!',
      content: language === 'ja' ? 
        `{{name}} さん、

「{{campaign_title}}」キャンペーンの締切まで1日となりました！

締切: {{deadline}}
ブランド: {{brand_name}}
보상: ₩{{reward_amount}}

🚨 緊急: まだ動画を投稿していない場合は、今日中に必ず投稿してください！
...
明日が締切です。締切を過ぎると보상をお支払いできませんので、必ず今日中に投稿を완료してください。

ご質問がございましたら、緊急でお問い合わせください。

CNEC Korea チーム` :
        `{{name}}님,

「{{campaign_title}}」 캠페인 마감까지 1일 남았습니다!

마감일: {{deadline}}
브랜드: {{brand_name}}
보상금: ₩{{reward_amount}}

🚨 긴급: 아직 영상을 게시하지 않으셨다면, 오늘 중에 반드시 게시해주세요!
...
내일이 마감일입니다. 마감일을 넘기면 보상금을 지급할 수 없으니 반드시 오늘 중에 게시를 완료해주세요.

궁금한 점이 있으시면 긴급히 문의해주세요.
...
CNEC Korea 팀`,
    ...
    {
      id: 'campaign_deadline_today',
      name: language === 'ja' ? 'キャンペーン締切当日リマインダー' : '캠페인 마감일 당일 알림',
      subject: language === 'ja' ? '🔥 今日がキャンペーン締切日です！' : '🔥 오늘이 캠페인 마감일입니다!',
      content: language === 'ja' ? 
        `{{name}} さん、

「{{campaign_title}}」キャンペーンの締切日です！

締切: {{deadline}}
ブランド: {{brand_name}}
보상: ₩{{reward_amount}}

🔥 最終警告: まだ動画を投稿していない場合は、今すぐ投稿してください！
...
今日中に投稿を완료しないと보상をお支払いできません。
時間がありませんので、今すぐ行動してください！

緊急のご質問がございましたら、すぐにお問い合わせください。

CNEC Korea チーム` :
        `{{name}}님,

「{{campaign_title}}」 캠페인 마감일입니다!

마감일: {{deadline}}
브랜드: {{brand_name}}
보상금: ₩{{reward_amount}}

🔥 최종 경고: 아직 영상을 게시하지 않으셨다면, 지금 즉시 게시해주세요!
...
오늘 중에 게시를 완료하지 않으면 보상금을 지급할 수 없습니다.
시간이 없으니 지금 즉시 행동해주세요!

긴급한 문의사항이 있으시면 즉시 연락해주세요.
...
CNEC Korea 팀`,
    ...
    },
    {
      ...
      name: language === 'ja' ? 'キャンペーン締切リマインダー（일반）' : '캠페인 마감 리마인더（일반）',
