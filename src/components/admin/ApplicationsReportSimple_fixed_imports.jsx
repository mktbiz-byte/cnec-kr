...
const ApplicationsReportSimple = () => {
  ...
  const texts = {
    ...
    ja: {
      ...
      searchPlaceholder: '名前、メール、캠페인명で검색...',
      ...
      driveAccessDescription: '승인された参加者にGoogleドライブ（動画업로드用）とGoogleスライド（ガイド）を提供します。',
      googleDriveUrl: 'Googleドライブ URL（動画업로드用）',
        ...
        <div className="bg-white shadow rounded-lg mb-6">
          <div className="px-4 py-5 sm:p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label htmlFor="campaign-filter" className="block text-sm font-medium text-gray-700">
                  {t.filterByCampaign}
                </label>
                <select
                  id="campaign-filter"
                ...
                <div className="sm:flex sm:items-start">
                  <div className="w-full">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* 타임스탬프 정보 */}
                      <div>
                        <h4 className="text-md font-semibold mb-3">처리 이력</h4>
                        <div className="bg-gray-50 p-4 rounded-lg">
