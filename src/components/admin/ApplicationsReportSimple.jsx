...
const ApplicationsReportSimple = () => {
  ...
  const texts = {
    ...
    en: {
      ...
      subtitle: 'Manage all campaign applications',
      totalApplications: 'Total Applications',
      pendingApplications: 'Pending',
      virtuallySelected: 'Virtual Selected',
      approvedApplications: 'Approved',
      rejectedApplications: 'Rejected',
      filterByCampaign: 'Filter by Campaign',
      filterByStatus: 'Filter by Status',
      searchPlaceholder: 'Search by name, email, campaign...',
      ...
      provideDriveAccess: 'Provide Drive Access',
      ...
      driveAccessTitle: 'Google Drive & Slides Access',
      driveAccessDescription: 'Provide Google Drive (for video uploads) and Google Slides (guide) to approved participants.',
      googleDriveUrl: 'Google Drive URL (for video uploads)',
      googleSlidesUrl: 'Google Slides URL (guide)',
      notes: 'Additional Notes',
      save: 'Save',
      exportExcel: 'Export Excel',
      autoGenerate: 'Auto Generate',
      autoGenerateDescription: 'Automatically generate URLs based on brand name and user name.'
    }
  }
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                              {selectedApplication.user_instagram_url && (
                                <div className="flex items-center">
                                  ...
                                  <a href={selectedApplication.user_instagram_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                    {selectedApplication.user_instagram_url}
                                  </a>
                                </div>
                              )}
                              {selectedApplication.user_youtube_url && (
                                <div className="flex items-center">
                                  ...
                                  <a href={selectedApplication.user_youtube_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                    {selectedApplication.user_youtube_url}
                                  </a>
                                </div>
                              )}
                              {selectedApplication.user_tiktok_url && (
                                <div className="flex items-center">
                                  ...
                                  <a href={selectedApplication.user_tiktok_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                    {selectedApplication.user_tiktok_url}
                                  </a>
                                </div>
                              )}
                              {!selectedApplication.user_instagram_url && !selectedApplication.user_youtube_url && !selectedApplication.user_tiktok_url && (
                                <p className="text-gray-500">소셜 미디어 정보 없음</p>
                              )}
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {[1, 2, 3, 4].map((num) => {
                            const campaignQuestion = selectedApplication[`campaign_question${num}`]
        ...
        {driveModal && selectedApplication && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              {/* 모달 내용 */}
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6 relative z-50">
                <div className="sm:flex sm:items-start">
                  <div className="w-full">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-lg leading-6 font-medium text-gray-900">
